						...
						<form method="POST" action="controller/function.php" class="form-horizontal">
							<div class="form-group">
								<div class="row">
									...
									<div class="col-md-3">
										<label>Conter İcon</label> <small>Simdiki icon -> <i class="fa <?php echo $counterprint['counter_icon']; ?>"></i></small>
										<select name="counter_icon" class="form-control m-b">
											<option value="<?php echo $counterprint['counter_icon']; ?>">&#xf101; icon seç</option>								
