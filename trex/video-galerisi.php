				...
				<div class="card-block">
					<div class="lightboxGallery">
						...
						<?php while ($vidprint=$vidsor->fetch(PDO::FETCH_ASSOC)) { ?>
							<a href="#" data-toggle="modal" data-target="#textModal<?php echo $vidprint['video_id']; ?>"><img style="max-width: 200px; max-height: 200px; border: 1px solid #f1f1f1;" src="assets/img/genel/unnamed.png" alt=""></a>
