			...
			<div class="card">
				...
				<div class="card-block">
					...
					<form method="POST" action="controller/function.php" class="form-horizontal">
						...
						<div class="form-group">
							<label>Sosyal İcon</label> <small>Simdiki icon -> <i class="fa <?php echo $sosyalwrite['sosyal_icon']; ?>"></i></small>
							<select name="sosyal_icon" class="form-control m-b">
								<option value="<?php echo $sosyalwrite['sosyal_icon']; ?>">&#xf101; icon seç</option>								
