							...
							while ($kategoricek=$kategorisor->fetch(PDO::FETCH_ASSOC)) {
								...
								<tr>
									...
									<td class="text-center">
										<a href="sube-duzenle.php?sube_id=<?php echo $kategoricek['kategori_id']; ?>" title="Düzenle" class="btn btn-sm btn-success"><i class="fa fa-edit"></i></a>
										<a href="controller/function.php?subesil=ok&sube_id=<?php echo $kategoricek['kategori_id']; ?>" title="Sil" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
									</td>
								</tr>
								<?php } ?>
							</tbody>
