			...
			<div class="card">
				...
				<div class="card-block">
					...
					<form method="POST" action="controller/function.php" enctype="multipart/form-data" class="form-horizontal">
						...
						<div class="form-group">
							<label>Bilgi İcon</label> <small>Simdiki icon -> <i class="fa <?php echo $hizmetwrite['bilgi_icon']; ?>"></i></small>
							<select name="bilgi_icon" class="form-control m-b">
								<option value="<?php echo $hizmetwrite['bilgi_icon']; ?>">&#xf101; icon seç</option>								
